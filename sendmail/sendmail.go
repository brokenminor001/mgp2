...
func Sendassigned(ticket string) {
	...
	// from := "asmolin@soyuzintegro.ru"

	// user := "asmolin"
	// password := "Oadnpvia04!!"

	// to := []string{
	// 	"asmolin@soyuzintegro.ru",
	// 	"operu_it_inbox_robot@gkm.ru",
	// 	"mariya.litvinova@gkm.ru",
	// }

	// addr := "mail.soyuzintegro.ru:25"
	// host := "mail.soyuzintegro.ru"

	// msg := []byte("From: megapolis@soyuzintegro.ru\r\n" +
	// 	"To: operu_it_inbox_robot@gkm.ru\r\n" +
	// 	"Subject: Incident/" + ticket + "/Assigned\r\n\r\n" +
	// 	"<incident><number>" + ticket + "</number><nameCharge>Богданова Светлана</nameCharge><phoneCharge>+7 (900) 500-00-00</phoneCharge></incident>\r\n")
